...
#ifndef _EasyActiveBuzzer_h
#define _EasyActiveBuzzer_h
...
class EasyActiveBuzzerClass
{
  public:
	...
	void beep(unsigned int beeps, void (*finishedCallbackFunction)());
	/* Beep sequence at a given frequency. */
	void beep(unsigned int const onDuration, unsigned int const offDuration, byte const beeps, unsigned int const pauseDuration, unsigned int const sequences);
	/* Beep sequence at a given frequency, with callback functionality. */
	void beep(unsigned int const onDuration, unsigned int const offDuration, byte const beeps, unsigned int const pauseDuration, unsigned int const sequences, void (*finishedCallbackFunction)());
	/* Beep at a given frequency, for an specific duration. */
	void singleBeep(unsigned int duration);
	/* Beep at a given frequency, for an specific duration, with callback functionality. */
	void singleBeep(unsigned int duration, void (*finishedCallbackFunction)());
	/* Stop beeping. */
	void stopBeep();
...
extern EasyActiveBuzzerClass EasyActiveBuzzer;
